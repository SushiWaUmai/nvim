...
function lspkeymap.on_attach(bufnr)
	...
	bufkeymap(bufnr, "n", "<A-h>", "<cmd>lua vim.lsp.buf.hover()<CR>", opts)
	bufkeymap(bufnr, "n", "gi", "<cmd>lua vim.lsp.buf.implementation()<CR>", opts)
	bufkeymap(bufnr, "n", "<A-H>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", opts)
	...
	bufkeymap(bufnr, "n", "<F2>", "<cmd>lua vim.lsp.buf.rename()<CR>", opts)
	bufkeymap(bufnr, "n", "<A-.>", "<cmd>lua vim.lsp.buf.code_action()<CR>", opts)
	bufkeymap(bufnr, "n", "gr", "<cmd>lua vim.lsp.buf.references()<CR>", opts)
	bufkeymap(bufnr, "n", "<A-F>", "<cmd>lua vim.lsp.buf.format({ async = true })<CR>", opts)
end
